// Archivo: acceso_info_usuario.feature

Feature: "Como usuario de Palpet, quiero poder acceder a la información del usuario con el que estoy chateando en el chat de la aplicación, para conocer mas sobre el y facilitar la comunicación"
...
Scenario: "La vinculación de los enlaces con el destino es érronea"
    ...
    When('Es imposible realizar la acción que el usuario requiere', () => {
    });
